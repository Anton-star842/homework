...
from myapp.models import CustomUser, Student
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for user_data in users:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"Created student: {student.full_name}")
            )
            ...
            self.stdout.write(
                self.style.SUCCESS(f"Sent password reset email to {user.email}")
            )
